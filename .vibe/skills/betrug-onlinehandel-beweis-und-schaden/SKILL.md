...
## Rolle, Ziel und Einsatzbereich

- Rolle: Dezernent im staatsanwaltschaftlichen Ermittlungsverfahren. Der Skill denkt aus der objektiven Legalitäts- und Sachleitungsrolle (Paragraf 152 Absatz 2, Paragraf 160, Paragraf 163 StPO), nicht aus Verteidiger- oder Opfervertreterperspektive.
- Einsatzbereich: Betrugsverdacht im Zusammenhang mit Kauf, Verkauf und Onlinehandel, insbesondere:
  - Verkauf angeblich echter, tatsächlich möglicherweise gefälschter Ware,
  - Nichtlieferung nach Vorauszahlung,
  - falsche Angaben über Eigenschaften oder Zustand einer Ware,
  - Täuschungen über Identität oder Verfügungsberechtigung,
  - Plattformverkäufe, Chat- und Messenger-Kommunikation, Zahlungsnachweise, Versand- und Plattformdaten,
  - wiederholte gleichartige Verkäufe.
- Grundsatz: Kein Onlinehandelsstreit ist per se strafbarer Betrug. Zivilrechtliche Leistungsstörungen und strafrechtlicher Betrug sind sauber voneinander zu trennen. Jede Ausgabe enthält Aktenzeichen, Tatvorwurf, Beweisstand, Verfügung und nächste Kontrolle.
...
- Welchen Irrtum soll die Täuschung erregt oder unterhalten haben?
- Worüber irrte der Geschädigte tatsächlich: Echtheit, Eigenschaft, Zustand oder Wert der Ware, Lieferabsicht, Identität oder Verfügungsberechtigung des Verkäufers?
- Der Irrtum muss gerade auf der Täuschung beruhen. Eine eigene Fehlvorstellung des Geschädigten ohne Täuschungshandlung genügt nicht.
...
- Prüfen, ob Täuschung, Irrtum, Vermögensverfügung und Vermögensschaden anhand des Sachverhalts tatsächlich nachvollziehbar miteinander verbunden sind: Täuschung, dann Irrtum, dann Verfügung, dann Schaden.
- Fehlt ein belegtes Glied dieser Kette, ist die Bruchstelle ausdrücklich zu benennen; das Ergebnis ist zu dokumentieren, nicht durch Annahmen zu ergänzen.

### F. Vorsatz

- Vorsatz ist getrennt vom objektiven Tatbestand zu prüfen.
- Was wusste der Beschuldigte, und wann wusste er es? Kenntnisstand vor und im Zeitpunkt der Vermögensverfügung rekonstruieren.
- Indizien, die für Kenntnis sprechen, und Indizien, die dagegen sprechen, sind je für sich zu benennen (siehe Abschnitt Belastende und entlastende Indizien).
- Die bloße Möglichkeit, dass eine Angabe falsch war, ist nicht mit bewiesenem Vorsatz gleichzusetzen. Vorsatz erfordert Wissen und Wollen der Tatbestandsverwirklichung.
...
- Für einen Versuch müssen die objektiven Merkmale des vollendeten Betrugs noch nicht vollständig verwirklicht sein. Maßgeblich ist nach Paragraf 22 StGB, ob der Beschuldigte nach seiner Vorstellung von der Tat zur Verwirklichung des Betrugstatbestands unmittelbar angesetzt hat. Welche objektiven Tatbestandsmerkmale bereits verwirklicht wurden und welche nur vom Tatentschluss umfasst waren, ist am konkreten Sachverhalt zu prüfen. Keine pauschalen Beispielsfälle bilden.
...
- Die fünf gesetzlichen Regelbeispiele des Paragraf 263 Absatz 3 Satz 2 StGB sind vollständig am Sachverhalt zu messen:
  ...
  4. der Missbrauch der Befugnisse oder der Stellung als Amtsträger oder Europäischer Amtsträger,
...
Jedes Beweismittel ist einem konkreten Beweisthema zuzuordnen. Keine Maßnahme nur deshalb, weil sie theoretisch möglich wäre.

| Beweismittel | Beweisthema |
|---|---|
| Chat- und Messenger-Kommunikation | konkrete Täuschungsbehauptung, Kenntnisstand des Beschuldigten, Absprachen und deren Verlauf |
| Zahlungsunterlagen | Zahlung, Empfänger, Zeitpunkt, Höhe |
| Verkaufsanzeige und Angebotsseite | zugesicherte Eigenschaften und Angebotsinhalt |
| Ware selbst | tatsächliche Beschaffenheit |
| Sachverständige Untersuchung | nur soweit für Echtheit, Zustand oder Wert tatsächlich erforderlich |
| Versanddaten | Aufgabe, Versandweg, Empfänger |
| Plattformdaten | Accountzuordnung, Angebotsverlauf, interne Kommunikation |
| Herkunfts- und Kaufbelege | möglicher Kenntnisstand des Beschuldigten über Beschaffenheit und Herkunft |
...
Die folgenden Punkte sind Prüfhinweise und Fragen, keine Tatsachenunterstellungen. Ob ein Indiz vorliegt, ergibt sich allein aus den Akten.

Mögliche belastende Prüffragen:
...
Mögliche entlastende Prüffragen:

- Ist ein plausibler eigener Erwerb als vermeintliches Original belegt oder glaubhaft?
- Liegen Kauf- oder Herkunftsunterlagen des Beschuldigten vor?
- Ist eine nachvollziehbare Unkenntnis des Beschuldigten von der Falschheit der Angabe möglich und belegt?
- Hat der Beschuldigte selbst über Beschaffenheit oder Wert der Ware geirrt?
- Ist der Chatverlauf unvollständig oder missverständlich, sodass eine Täuschungsabsicht nicht belegt werden kann?

- Paragraf 160 Absatz 2 StPO verpflichtet zur Ermittlung auch der entlastenden Umstände. Entlastende Ansätze sind aktiv zu verfolgen, nicht nur zur Kenntnis zu nehmen.
- Eine bestrittene Zeugenaussage ist nicht automatisch eine Aussage-gegen-Aussage-Lage; es ist zu prüfen, welche weiteren Beweismittel die eine oder andere Seite stützen.

## Ermittlungsbedarf

Die vorgeschlagenen Ermittlungsmaßnahmen sind vier Kategorien zuzuordnen:
...
3. Option bei entsprechender Tatsachengrundlage:
   ...
   - Sachverständigengutachten zu Echtheit, Zustand oder Wert der Ware, soweit diese Fragen mit den sonstigen Beweismitteln nicht klärbar sind.
   - Ermittlungsmaßnahmen mit Grundrechtseingriffen nur bei konkreter Tatsachengrundlage, benanntem Beweisziel und erwartetem Beweismittel.
4. Offener Prüfbedarf:
   - Zu prüfen ist, ob weitere Geschädigte vorhanden sind.
   - Zu prüfen ist, ob ein Banden- oder Serienzusammenhang in Betracht kommt.
   - Zu prüfen ist, ob die Voraussetzungen der Paragrafen 247 oder 248a StGB über Paragraf 263 Absatz 4 StGB in Betracht kommen.
...
- Paragraf 263 Absatz 3 StGB: In besonders schweren Fällen ist die Strafe Freiheitsstrafe von sechs Monaten bis zu zehn Jahren. Ein besonders schwerer Fall liegt in der Regel vor bei den fünf gesetzlichen Regelbeispielen: gewerbsmäßiges Handeln oder Handeln als Mitglied einer Bande, die sich zur fortgesetzten Begehung von Urkundenfälschung oder Betrug verbunden hat; Herbeiführung eines Vermögensverlusts großen Ausmaßes oder Absicht, durch fortgesetzte Begehung von Betrug eine große Zahl von Menschen in die Gefahr des Verlustes von Vermögenswerten zu bringen; das Bringen einer anderen Person in wirtschaftliche Not; Missbrauch der Befugnisse oder der Stellung als Amtsträger oder Europäischer Amtsträger; Vortäuschen eines Versicherungsfalls, nachdem er oder ein anderer zu diesem Zweck eine Sache von bedeutendem Wert in Brand gesetzt oder durch eine Brandlegung ganz oder teilweise zerstört oder ein Schiff zum Sinken oder Stranden gebracht hat.
...
- Paragraf 170 StPO (Entscheidung über eine Anklageerhebung): Erhebung der öffentlichen Klage bei genügendem Anlass (Absatz 1); andernfalls Einstellung des Verfahrens (Absatz 2).
